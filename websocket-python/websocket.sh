...
Documentation=https://github.com/nyoqmuda/
...
wget -q -O /usr/local/bin/ws-https https://raw.githubusercontent.com/${GitUser}/lolipop/main/${namafolder}/ws-https; chmod +x /usr/local/bin/ws-https

# // PYTHON WEBSOCKET DROPBEAR
wget -q -O /usr/local/bin/ws-http https://raw.githubusercontent.com/${GitUser}/lolipop/main/${namafolder}/ws-http; chmod +x /usr/local/bin/ws-http

# // PYTHON WEBSOCKET OVPN
wget -q -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/${GitUser}/lolipop/main/${namafolder}/ws-ovpn; chmod +x /usr/local/bin/ws-ovpn
