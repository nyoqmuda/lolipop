...
export patchtls=/kurita-vmesswstls
export patchnontls=/kurita-vmesswsntls
...
export patchtls=/kurita-vlesswstls
export patchnontls=/kurita-vlesswsntls
export uuid=$(cat /proc/sys/kernel/random/uuid)
...
export vlesslink1="vless://${uuid}@${sts}${MYIP}:$xtls?security=xtls&encryption=none&headerType=none&type=tcp&flow=xtls-rprx-direct&sni=$sni#${user}"
export vlesslink2="vless://${uuid}@${sts}${MYIP}:$xtls?security=xtls&encryption=none&headerType=none&type=tcp&flow=xtls-rprx-splice&sni=$sni#${user}"
...
export vlesslink1="vless://${uuid}@${MYIP}:$xtls?security=xtls&encryption=none&headerType=none&type=tcp&flow=xtls-rprx-direct&sni=bug.com#${user}"
export vlesslink2="vless://${uuid}@${MYIP}:$xtls?security=xtls&encryption=none&headerType=none&type=tcp&flow=xtls-rprx-splice&sni=bug.com#${user}"
