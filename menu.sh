...
# USERNAME
rm -f /usr/bin/user
username=$(curl -sS ipv4.icanhazip.com)
echo "$username" >/usr/bin/user
# Order ID
rm -f /usr/bin/ver
user=$(curl -sS ipv4.icanhazip.com)
echo "$user" >/usr/bin/ver
# validity
rm -f /usr/bin/e
valid=$(curl -sS ipv4.icanhazip.com)
...
echo -e "  \e[$number (•5)\e[m \e[$below CHECK RUNNING\e[m        \e[$number (•9)\e[m \e[$below XRAY VERSION\e[m"
...
echo -e " \e[$line╒════════════════════════════════════════════════════════════╕\e[m"
echo -e "  \e[$below Version Name         : SSH XRAY WEBSOCKET MULTIPORT v1.0"
echo -e "  \e[$below Autoscript By        : nyoqmuda"
echo -e "  \e[$below License Key          : XONF7-PMUOL-HU7P4-D1QQX"
echo -e "  \e[$below Certificate Status   : Lifetime"
echo -e " \e[$line╘════════════════════════════════════════════════════════════╛\e[m"
echo -e "\e[$below "
