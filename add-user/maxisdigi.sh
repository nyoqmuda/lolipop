...
patchtls=/kurita-vmesswstls
patchnontls=/kurita-vmesswsntls
...
patchtls=/kurita-vlesswstls
patchnontls=/kurita-vlesswsntls
uuid=$(cat /proc/sys/kernel/random/uuid)
read -p "   Bug Address (Example: www.google.com) : " address
read -p "   Bug SNI/Host (Example : m.facebook.com) : " sni
read -p "   Expired (days) : " masaaktif
...
patchtls=/kurita-trojanwstls
patchnone=/kurita-trojanwsntls
read -p "   Bug Address (Example: www.google.com) : " address
